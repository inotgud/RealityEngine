...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("RealityEngine", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("RealityEngine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "120";
		app.meta["company"] = "GoodTR";
		app.meta["file"] = "RealityEngine";
		app.meta["name"] = "Friday Night Funkin': Reality Engine";
		app.meta["packageName"] = "com.goodtr.Realityengine";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': Reality Engine",
			width: 1280,
			x: null,
			y: null,
		};
