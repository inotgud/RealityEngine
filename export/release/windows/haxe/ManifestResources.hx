...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_custom_custom_mainmenustates_test_freakymenu_ogg extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_console_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_keybinds_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_music_old_ogg extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_sounds_cuts1_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_sounds_cuts2_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_sounds_cuts3_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_sounds_keyboardpressdwnloadedstephenpog_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_sounds_missioncomplete_ogg extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_tankmankilled1_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_tankmankilled1_xml extends null { }
...
@:keep @:font("assets/fonts/muff.ttf") @:noCompletion #if display private #end class __ASSET__assets_fonts_muff_ttf extends lime.text.Font {}
@:keep @:font("assets/fonts/muffengineReality.ttf") @:noCompletion #if display private #end class __ASSET__assets_fonts_muffenginereality_ttf extends lime.text.Font {}
@:keep @:font("assets/fonts/muffnew.ttf") @:noCompletion #if display private #end class __ASSET__assets_fonts_muffnew_ttf extends lime.text.Font {}
...
@:keep @:expose('__ASSET__assets_fonts_muff_ttf') @:noCompletion #if display private #end class __ASSET__assets_fonts_muff_ttf extends lime.text.Font { public function new () { #if !html5 __fontPath = "assets/fonts/muff.ttf"; #else ascender = null; descender = null; height = null; numGlyphs = null; underlinePosition = null; underlineThickness = null; unitsPerEM = null; #end name = "PhantomMuff 1.5"; super (); }}
@:keep @:expose('__ASSET__assets_fonts_muffenginereality_ttf') @:noCompletion #if display private #end class __ASSET__assets_fonts_muffenginereality_ttf extends lime.text.Font { public function new () { #if !html5 __fontPath = "assets/fonts/muffengineReality.ttf"; #else ascender = null; descender = null; height = null; numGlyphs = null; underlinePosition = null; underlineThickness = null; unitsPerEM = null; #end name = "PhantomMuff1.5RealityEngine"; super (); }}
@:keep @:expose('__ASSET__assets_fonts_muffnew_ttf') @:noCompletion #if display private #end class __ASSET__assets_fonts_muffnew_ttf extends lime.text.Font { public function new () { #if !html5 __fontPath = "assets/fonts/muffnew.ttf"; #else ascender = null; descender = null; height = null; numGlyphs = null; underlinePosition = null; underlineThickness = null; unitsPerEM = null; #end name = "PhantomMuff 1.5"; super (); }}
