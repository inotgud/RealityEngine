...
#endif
HX_DECLARE_STACK_FRAME(_hx_pos_bc09bde916c21592_11_new)
...
class HXCPP_CLASS_ATTRIBUTES RangeError_obj : public  ::openfl::errors::Error_obj
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< RangeError_obj > __new(::String __o_message) {
			::hx::ObjectPtr< RangeError_obj > __this = new RangeError_obj();
			__this->__construct(__o_message);
			return __this;
		}

		inline static ::hx::ObjectPtr< RangeError_obj > __alloc(::hx::Ctx *_hx_ctx,::String __o_message) {
...
HXLINE(  14)		( ( ::openfl::errors::Error)(__this) )->name = HX_("RangeError",eb,ac,85,3c);
            	}
