...
class HXCPP_CLASS_ATTRIBUTES CoolUtil_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::flixel::FlxSprite addBG2( ::flixel::FlxState f);
		static ::Dynamic addBG2_dyn();

		static void cameraZoom( ::flixel::FlxCamera target,Float zoomLevel,Float speed, ::Dynamic style, ::Dynamic type);
		static ::Dynamic cameraZoom_dyn();
