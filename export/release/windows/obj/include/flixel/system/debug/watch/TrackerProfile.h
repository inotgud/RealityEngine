...
HX_DECLARE_STACK_FRAME(_hx_pos_045fa5a979169169_282_new)
...
class HXCPP_CLASS_ATTRIBUTES TrackerProfile_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< TrackerProfile_obj > __new(::hx::Class ObjectClass,::Array< ::String > Variables,::Array< ::Dynamic> Extensions) {
			::hx::ObjectPtr< TrackerProfile_obj > __this = new TrackerProfile_obj();
			__this->__construct(ObjectClass,Variables,Extensions);
			return __this;
		}

		inline static ::hx::ObjectPtr< TrackerProfile_obj > __alloc(::hx::Ctx *_hx_ctx,::hx::Class ObjectClass,::Array< ::String > Variables,::Array< ::Dynamic> Extensions) {
...
HXLINE( 283)		( ( ::flixel::_hx_system::debug::watch::TrackerProfile)(__this) )->objectClass = ObjectClass;
HXLINE( 284)		( ( ::flixel::_hx_system::debug::watch::TrackerProfile)(__this) )->variables = Variables;
HXLINE( 285)		( ( ::flixel::_hx_system::debug::watch::TrackerProfile)(__this) )->extensions = Extensions;
            	}
