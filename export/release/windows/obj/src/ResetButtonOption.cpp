...
HX_DEFINE_STACK_FRAME(_hx_pos_0bd54ba2a6db792a_1177_new,"ResetButtonOption","new",0xc052ff48,"ResetButtonOption.new","Options.hx",1177,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_0bd54ba2a6db792a_1183_press,"ResetButtonOption","press",0xe9df0c6b,"ResetButtonOption.press","Options.hx",1183,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_0bd54ba2a6db792a_1191_updateDisplay,"ResetButtonOption","updateDisplay",0x9c4e7021,"ResetButtonOption.updateDisplay","Options.hx",1191,0x9d9a0240)

void ResetButtonOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_0bd54ba2a6db792a_1177_new)
HXLINE(1178)		super::__construct();
HXLINE(1179)		this->description = desc;
            	}
...
bool ResetButtonOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_0bd54ba2a6db792a_1183_press)
HXLINE(1184)		::flixel::FlxG_obj::save->data->__SetField(HX_("resetButton",21,e5,f4,79),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("resetButton",21,e5,f4,79),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE(1185)		this->display = this->updateDisplay();
HXLINE(1186)		return true;
            	}


::String ResetButtonOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_0bd54ba2a6db792a_1191_updateDisplay)
HXDLIN(1191)		::String _hx_tmp;
HXDLIN(1191)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("resetButton",21,e5,f4,79),::hx::paccDynamic)) ))) {
HXDLIN(1191)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN(1191)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN(1191)		return ((HX_("Reset Button: < ",6d,62,49,10) + _hx_tmp) + HX_(" >",1e,1c,00,00));
            	}
