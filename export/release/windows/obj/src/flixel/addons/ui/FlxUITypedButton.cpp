...
static const int _hx_array_data_221567a7_39[] = {
	(int)0,(int)1,(int)2,(int)3,(int)4,(int)5,
};
static const int _hx_array_data_221567a7_40[] = {
	(int)0,(int)1,(int)2,
};
...
HXLINE( 609)				frame_indeces = ::Array_obj< int >::fromData( _hx_array_data_221567a7_39,6);
            			}
            			else {
HXLINE( 613)				frame_indeces = ::Array_obj< int >::fromData( _hx_array_data_221567a7_40,3);
            			}
            		}
            		else {
...
static ::hx::StaticInfo *FlxUITypedButton_obj_sStaticStorageInfo = 0;
#endif
