...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("RealityEngine",52,4d,7d,84),::ApplicationMain_obj::create_dyn());
...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("306",f9,dc,26,00));
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("GoodTR",1b,dc,7b,96));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("RealityEngine",52,4d,7d,84));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Friday Night Funkin': Reality Engine",25,cb,68,7f));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.goodtr.Realityengine",cc,06,5c,9c));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Friday Night Funkin': Reality Engine",25,cb,68,7f))
