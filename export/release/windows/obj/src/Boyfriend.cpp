...
HXDLIN(  35)			if (::StringTools_obj::endsWith(this->curCharacter,HX_("-car",07,0e,0a,1e))) {
HXLINE(  35)				_hx_tmp3 = !(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("sing",4f,96,53,4c)));
            			}
            			else {
...
HXLINE(  36)				this->playAnim(HX_("idleHair",56,14,f8,39),null(),null(),null());
            			}
HXLINE(  38)			bool _hx_tmp4;
HXDLIN(  38)			if ((this->animation->_curAnim->name == HX_("firstDeath",e4,d8,fc,14))) {
HXLINE(  38)				_hx_tmp4 = this->animation->_curAnim->finished;
            			}
            			else {
HXLINE(  38)				_hx_tmp4 = false;
            			}
HXDLIN(  38)			if (_hx_tmp4) {
HXLINE(  40)				this->playAnim(HX_("deathLoop",b8,0b,79,2e),null(),null(),null());
            			}
            		}
