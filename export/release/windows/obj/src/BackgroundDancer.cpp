...
HX_LOCAL_STACK_FRAME(_hx_pos_d86c65e08c62e087_23_dance,"BackgroundDancer","dance",0x01b85892,"BackgroundDancer.dance","BackgroundDancer.hx",23,0x2f720451)
...
HXLINE(  13)		this->set_frames(::Paths_obj::getSparrowAtlas(HX_("limo/limoDancer",8e,b6,e5,ea),HX_("shared",a5,5e,2b,1d),null()));
...
void BackgroundDancer_obj::dance(){
            	HX_STACKFRAME(&_hx_pos_d86c65e08c62e087_23_dance)
HXLINE(  24)		this->danceDir = !(this->danceDir);
HXLINE(  26)		if (this->danceDir) {
HXLINE(  27)			this->animation->play(HX_("danceRight",a9,7f,a6,91),true,null(),null());
            		}
            		else {
HXLINE(  29)			this->animation->play(HX_("danceLeft",da,cc,f9,df),true,null(),null());
            		}
            	}
