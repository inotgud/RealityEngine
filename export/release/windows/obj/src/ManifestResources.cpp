...
HXLINE(  53)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_muff_ttf >());
HXLINE(  54)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_muffenginereality_ttf >());
HXLINE(  55)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_muffnew_ttf >());
HXLINE(  56)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_pixel_otf >());
HXLINE(  57)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_vcr_ttf >());
...
HXLINE(  78)		{
HXLINE(  78)			::String v2 = (::ManifestResources_obj::rootPath + HX_("manifest/sm.json",dc,54,48,0c));
HXDLIN(  78)			::lime::utils::Assets_obj::libraryPaths->set(HX_("sm",9a,64,00,00),v2);
            		}
HXLINE(  79)		{
HXLINE(  79)			::String v3 = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  79)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v3);
            		}
...
HXLINE(  88)		library = ::lime::utils::Assets_obj::getLibrary(HX_("sm",9a,64,00,00));
HXLINE(  89)		if (::hx::IsNotNull( library )) {
HXLINE(  89)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  90)			::ManifestResources_obj::preloadLibraryNames->push(HX_("sm",9a,64,00,00));
            		}
HXLINE(  91)		library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
