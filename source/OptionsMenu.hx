...
class OptionCata extends FlxSprite
{
	...
	public function new(x:Float, y:Float, _title:String, _options:Array<Option>, middleType:Bool = false)
	{
		...
		titleObject.setFormat(Paths.font("muffnew.ttf"), 35, FlxColor.WHITE, FlxTextAlign.LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		for (i in 0...options.length)
		{
			...
			text.setFormat(Paths.font("muffnew.ttf"), 35, FlxColor.WHITE, FlxTextAlign.CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
			text.borderSize = 3;
	...
	override function create()
	{
		options = [
			new OptionCata(50, 40, "Gameplay", [
				...
				new RedesignedMenu("Redesigned menu namely Reality Engine Menu"),
				new RedesignedMenuTwo("Redesigned menu namely Reality Engine Menus"),
                new EngineUsernameOption("Change your funkin Reality engine name (Varies in each mode)"),
		...
		descText.setFormat(Paths.font("muffnew.ttf"), 20, FlxColor.WHITE, FlxTextAlign.LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
