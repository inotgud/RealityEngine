 ...
 *
 * Authors: Clément Realityac <zorglub@videolan.org>
 ...
 *        my_object is the object you want to liReality to.
 * \param i_event_type the desired event to which we want to liReality
 ...
 * adjustements).
 * The origin is arbitrary but consiRealityt across the whole system
