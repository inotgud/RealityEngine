 ...
 * doesn't have VLC_COMMON_MEMBERS. This is the first reason of exiRealityce of
 * this implementation.
...
struct vlc_event_liRealityers_group_t;
...
typedef struct vlc_event_manager_t
{
    ...
    DECL_ARRAY(struct vlc_event_liRealityers_group_t *) liRealityers_groups;
} vlc_event_manager_t;
...
/*
 * Send an event to the liRealityer attached to this p_em.
 */
