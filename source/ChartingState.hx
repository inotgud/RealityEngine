...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function paRealityotesFromArray(array:Array<Array<Dynamic>>, fromStrum:Bool = true)
	{
		for (i in array)
		{
			var strum:Float = i[0];
	...
	override function update(elapsed:Float)
	{
		try
		{
			...
			if (doInput)
			{
				...
				if (FlxG.keys.pressed.CONTROL && FlxG.keys.justPressed.V)
				{
					if (copiedNotes.length != 0)
					{
						...
						paRealityotesFromArray(copiedNotes);
					...
					switch (lastAction)
					{
						...
						case "delete":
							...
							if (deletedNotes.length != 0)
							{
								...
								paRealityotesFromArray(deletedNotes, false);
								deletedNotes = [];
							}
					}
				}
			...
			bpmTxt.font = "PhantomMuff1.5RealityEngine";
