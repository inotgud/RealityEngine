...
class Debug
{
	static final LOG_STYLE_ERROR:LogStyle = new LogStyle('[Reality ERROR] ', 'FF8888', 12, true, false, false, 'flixel/sounds/beep', true);
	static final LOG_STYLE_WARN:LogStyle = new LogStyle('[Reality WARN ] ', 'D9F85C', 12, true, false, false, 'flixel/sounds/beep', true);
	static final LOG_STYLE_INFO:LogStyle = new LogStyle('[Reality INFO ] ', '5CF878', 12, false);
	static final LOG_STYLE_TRACE:LogStyle = new LogStyle('[Reality TRACE] ', '5CF878', 12, false);
	...
	public static function onInitProgram()
	{
		...
		logInfo('RealityEngine version: ${MainMenuState.RealityEngineVer}');
	}
	...
	public static function onGameStart()
	{
		...
		if (FlxG.save.data.debugLogLevel == null)
			FlxG.save.data.debugLogLevel = "Reality TRACE";
	...
	static function writeToLogFile(data:Array<Dynamic>, logLevel:String = "Reality TRACE")
	{
...
class DebugLogWriter
{
	...
	public static final LOG_LEVELS = ['Reality ERROR', 'Reality WARN', 'Reality INFO', 'Reality TRACE'];
	 ...
	 */
	public function write(input:Array<Dynamic>, logLevel = 'Reality TRACE'):Void
	{
